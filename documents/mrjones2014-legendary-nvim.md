...
slug: mrjones2014-legendary-nvim
category: Keybinding
created: 'Mar 12, 2022 11:35'
description: "\U0001F5FA️ A legend for your keymaps, commands, and autocmds, with which-key.nvim integration (requires Neovim nightly)"
...
topics:
  ...
  - vim-commands
  - which-key
updated_at: '2022-03-12T20:58:52Z'
---
# Legendary
...
![demo](./demo.gif) <sup>Theme used in recording is [lighthaus.nvim](https://github.com/mrjones2014/lighthaus.nvim). The finder UI is handled by [telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) via [dressing.nvim](https://github.com/stevearc/dressing.nvim). See [Prerequisites](#prerequisites) for details.</sup>
...
of calling the function. For example, you probably want to map `vim.lsp.buf.formatting_sync`, *not*
`vim.lsp.buf.formatting_sync()`.
